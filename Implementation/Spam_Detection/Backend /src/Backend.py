...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://mail.google.com", "chrome-extension://ogjcfhejcakiikmjmmkjajkhcgckjnkm"],
    allow_methods=["GET", "POST"],
    allow_headers=["*"],
)
logger.info("CORS middleware added.")

DATABASE_URL = "mysql+pymysql://root:Gunleen%40123@localhost:3306/email_classification_db"
